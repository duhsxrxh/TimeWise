...
import com.example.timewise.databinding.ActivityActScreenDarkModeBinding
...
class ActScreenDarkMode : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val binding = ActivityActScreenDarkModeBinding.inflate(layoutInflater)
